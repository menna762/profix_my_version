...
class EditProfilePageForTechnical extends StatefulWidget {
  static String routeName = "editProfilePageForTechnical";
  const EditProfilePageForTechnical({super.key});

  @override
  _EditProfilePageState createState() => _EditProfilePageState();
}

class _EditProfilePageState extends State<EditProfilePageForTechnical> {
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      final response = await _authService.updateUser(
        userProvider.userId!, // Fixed from id to userId based on ServiceAreasPage
        updateData,
